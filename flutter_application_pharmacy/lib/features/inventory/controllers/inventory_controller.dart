...
class InventoryController extends ChangeNotifier {
  ...
  Future<bool> _updateMedicationStatus(String medicationId, String status) async {
    final success = await _firebaseService.updateMedicationStatus(medicationId, status);
    if (!success) {
      return false;
    }

    final medicationIndex = _medications.indexWhere((item) => item['id'] == medicationId);
