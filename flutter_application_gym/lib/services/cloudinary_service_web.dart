...
class CloudinaryServiceWeb {
  /// Upload image to Cloudinary using XFile (web-compatible)
  ...
  static Future<String?> uploadImageFromXFile(
    ...
    try {
      print('🚀 CLOUDINARY WEB SERVICE: Starting upload...');
      ...
      if (!CloudinaryConfig.isConfigured) {
        print('❌ CLOUDINARY WEB SERVICE: Not configured properly!');
        return null;
      }
      
      print('✅ CLOUDINARY WEB SERVICE: Configuration is valid');
      ...
      if (response.statusCode == 200) {
        print('✅ CLOUDINARY WEB SERVICE: Upload successful!');
        ...
        print('✅ CLOUDINARY WEB SERVICE: Upload completed!');
        ...
        print('❌ CLOUDINARY WEB SERVICE: Upload failed!');
      ...
      print('💥 CLOUDINARY WEB SERVICE: Exception caught!');
